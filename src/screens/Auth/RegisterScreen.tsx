...
const RegisterScreen: React.FC<RegisterScreenProps> = ({ navigation }) => {
          ...
          [
            {
              ...
              onPress: async () => {
                try {
                  ...
                  await getFirebaseCompatSync().auth().signOut();
  ...
  const handleRegister = async () => {
    ...
    try {
      ...
      const userCredential = await getFirebaseCompatSync().auth().createUserWithEmailAndPassword(email, password);
        ...
        try {
          ...
          try {
            ...
            await getFirebaseCompatSync().firestore().runTransaction(async (transaction) => {
              ...
              const emailRef = email ? getFirebaseCompatSync().firestore().collection('emails').doc(email.toLowerCase()) : null;
