...
export const getDeviceLayoutConfig = (insets?: any): DeviceLayoutConfig => {
  ...
  let baseFontSize = isSmallDevice ? 10 : isMediumDevice ? 11 : 12;
  let baseIconSize = isSmallDevice ? 24 : isMediumDevice ? 26 : 28;
  ...
  // CRITICAL: Ensure minimum icon size for visibility (increased from 22 to 24)
  baseIconSize = Math.max(baseIconSize, 24);
