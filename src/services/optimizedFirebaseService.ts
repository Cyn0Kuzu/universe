...
export class OptimizedFirebaseService {
  ...
  async batchRead(
    ...
    return (await performanceOptimizer.batch([async () => {
      ...
      const queryPromises = queries.map(query => 
        getFirebaseCompatSync().firestore()
  ...
  async readCollection(
    ...
    return (await performanceOptimizer.batch([async () => {
      ...
      let query: any = getFirebaseCompatSync().firestore().collection(collection); // firebase.firestore.Query
  ...
  async batchWrite(operations: Array<{
    ...
    return (await performanceOptimizer.batch([async () => {
      ...
      operations.forEach(operation => {
        const docRef = getFirebaseCompatSync().firestore()
